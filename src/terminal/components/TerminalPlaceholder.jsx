  ...
  <div className="terminal-placeholder">
    <div className="placeholder-content">
      ...
      <h2 style={{ color: 'var(--pfpt-neutral-white)', fontSize: '24px', marginBottom: '10px' }}>
        Waiting to Run {projectName ? projectName.toUpperCase() : 'Project'}
      </h2>
      <p style={{ color: 'var(--pfpt-neutral-300)', fontSize: '16px' }}>
        Press <b>RUN {projectName ? projectName.toUpperCase() : 'Project'}</b> to start your configuration and see output here.
      </p>
    </div>
  </div>
);
