...
import OverflowTabsDropdown from '../../tab-info/components/OverflowTabsDropdown';
import '@xterm/xterm/css/xterm.css';
import configSidebarCommands from '../../project-config/config/configurationSidebarCommands.json';
